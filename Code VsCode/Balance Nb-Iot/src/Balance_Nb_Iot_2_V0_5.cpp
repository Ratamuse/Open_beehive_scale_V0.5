...
#include <Arduino.h>
#define powerscale 8
#define powermodem 38

#define BOARD_MODEM_PWR_PIN 48
#define BOARD_MODEM_DTR_PIN 18
//#define BOARD_MODEM_RI_PIN 
#define BOARD_MODEM_RXD_PIN 9
#define BOARD_MODEM_TXD_PIN 10
...
const char* deviceName = "F5";  // ou "G3" selon le microcontrôleur
...
void initpower() {
    ...
    pinMode(powerscale, OUTPUT);
  digitalWrite(powerscale, HIGH);
  delay(100);
